========================================================================
    ACTIVE TEMPLATE LIBRARY : UVCPlugin Project Overview
========================================================================

AppWizard has created this UVCPlugin project for you to use as the starting point for
...
UVCPlugin.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (UVCPlugin.h)
        GUID definitions                                (UVCPlugin_i.c)
        A type library                                  (UVCPlugin.tlb)
        Marshaling code                                 (UVCPlugin_p.c and dlldata.c)

UVCPlugin.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in UVCPlugin.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named UVCPlugin.pch and a precompiled types file named StdAfx.obj.
...
UVCPluginps.vcxproj
	...
	dlldata.c, UVCPlugin_i.c and UVCPlugin_p.c which are required
	to build the proxy/stub DLL.

UVCPluginps.vcxproj.filters

...
namespace TopGear
{
	...
	{
	public:
		static std::vector<std::shared_ptr<IVideoStream>> CreateVideoStreams(std::shared_ptr<IGenericVCDevice> &pSource) = delete;

		typedef std::function<void(IVideoFramePtr &)> ReaderCallbackFn;
